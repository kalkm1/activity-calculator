...
def avg_activity(a_o, t, s_T):
    ...
    a_t = (a_o/-la) * np.exp(-la*t)
    a_t0 = (a_o/-la)

    return (a_t - a_t0)/t


def write_output(obs_len, t_obs, a_avg, tot_t, tot_avg_a):
...
def main(s_info_a, s_info_dt, s_T, obs_start, obs_end):
    ...
    write_output(obs_len, t_obs, a_avg, tot_t, tot_avg_a)
...
if __name__ == "__main__":
    ...
    # run code
    main(s_info_a, s_info_dt, s_T, obs_start, obs_end)
